...
private:
    std::vector<std::shared_ptr<Vehicle>> _vehiclesWaiting;  // list of all vehicles waiting to enter this intersection
    std::vector<std::promise<void>> _promisesAssociated;     // list of associated promises
};
